  ...
  return (
    ...
    >
      ...
      <div className="flex items-center lg:hidden">
        ...
        <div
          className={`fixed left-0 top-14 h-[100dvh] w-full bg-accent ${open ? "opacity-100" : "hidden opacity-0"} p-6 transition-all lg:hidden ${path.substring(0, 6) == "/blog/" ? "bg-light" : ""}`}
        >
